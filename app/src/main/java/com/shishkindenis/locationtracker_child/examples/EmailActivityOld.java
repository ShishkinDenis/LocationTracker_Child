...
//    boolean gpsIsStopped;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // API 24+
            connectivityManager.registerDefaultNetworkCallback(new com.shishkindenis.locationtracker_child.activities.EmailAuthActivity.ConnectivityCallback());
...
//                            updateUI(user);
                            ...
                            Toast.makeText(com.shishkindenis.locationtracker_child.activities.EmailAuthActivity.this, "Authentication failed.",
                                    Toast.LENGTH_SHORT).show();
//                            updateUI(null);
                        }
